...
${OBJECTDIR}/GestorAssets.o: GestorAssets.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestorAssets.o GestorAssets.cpp

${OBJECTDIR}/GestorInputs.o: GestorInputs.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestorInputs.o GestorInputs.cpp

${OBJECTDIR}/Huevo.o: Huevo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Huevo.o Huevo.cpp
...
${OBJECTDIR}/MaquinaEstados.o: MaquinaEstados.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MaquinaEstados.o MaquinaEstados.cpp
...
${OBJECTDIR}/Terodactile.o: Terodactile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terodactile.o Terodactile.cpp
